...
const Login = () => {
    ...
    const submit = async (e: SyntheticEvent) => {
        ...
        try{
            setLoading(true);
            const rawResponse = await fetch(`${process.env.API_URL}/auth/login`, {
                method: 'POST',
                headers: {
                ...
                <div className="bg-white rounded-2xl shadow-2xl flex flex-col lg:flex lg:flex-row lg:w-2/3 items-center w-95 max-w-4xl">
                    ...
                    <div className="py-10">
                        ...
                        <div className="flex justify-between w-64 mb-5">
                            ...
                            >{!loading && "Sign In"} {loading && <svg role="status" className="inline mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-pink-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-100 lg:w-2/5 bg-pink-500 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12 ">
                        ...
                        <p className="mb-2">Create an account now to get your personal cake!</p>
                        <Link href="/register"><a  className="border-2 border-white rounded-full px-12 py-2 inline-block
                        font-semibold hover:bg-white hover:text-pink-400">Sign Up</a>
                        </Link>
                    </div>
