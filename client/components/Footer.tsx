...
const Footer = () => {
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="">
        ...
        <p>
            Welcome to the Cake shop. Created by Michael Agbonyeme. Phone Number +2348025748960. Due to time, some elements do not fully function,
            but all requested functionality in the email works as requested. If more time was added, the receipt ID, more CRUD operations for administrators to make it a fully functional applicaiton.
        </p>
      </div>
      <div className="">
  ...
  <div className="text-center p-6 bg-gray-200">
    ...
    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Cake <span className="text-pink-500">Shop</span></a>
  </div>
</footer>
    )
}
